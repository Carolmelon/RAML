...
class Options():
    ...
    def add_few_shot_options(self):
        self.parser.add_argument('--update_batch_size', type=int, default=1)    # k-shot
        self.parser.add_argument('--update_batch_size_eval', type=int, default=5)   # k-query
        # support编码n条
        self.parser.add_argument('--support_n_context', type=int, default=1)
        self.parser.add_argument('--freeze_bert', type=int, default=0)
        # 数据集
        self.parser.add_argument('--datasource', type=str)
